//
//  CountyWeeklyBarTableViewCell.swift
//  webscraping
//
...
class CountyWeeklyBarTableViewCell: UITableViewCell, ChartViewDelegate {
    
    @IBOutlet weak var barChart: BarChartView!
    @IBOutlet weak var countyWeekBarView: UIView!
    ...
    override func awakeFromNib() {
        ...
        countyWeekBarView.backgroundColor = AppDelegate().uicolorFromHex(rgbValue: 0x313547)
