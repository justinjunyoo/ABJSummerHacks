//
//  CountyAllLineTableViewCell.swift
//  webscraping
//
...
class CountyAllLineTableViewCell: UITableViewCell, ChartViewDelegate{
    
    @IBOutlet weak var countyAllLineView: UIView!
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        countyAllLineView.backgroundColor = AppDelegate().uicolorFromHex(rgbValue: 0x313547)
