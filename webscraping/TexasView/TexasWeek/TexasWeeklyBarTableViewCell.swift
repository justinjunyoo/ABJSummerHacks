//
//  TexasWeeklyBarTableViewCell.swift
//  webscraping
//
...
class TexasWeeklyBarTableViewCell: UITableViewCell, ChartViewDelegate {
    
    @IBOutlet weak var barChart: BarChartView!
    @IBOutlet weak var texasWeekBarView: UIView!
    var circleColors: [NSUIColor] = []
    
    override func awakeFromNib() {
        super.awakeFromNib()
        barChart.delegate = self
        texasWeekBarView.backgroundColor = AppDelegate().uicolorFromHex(rgbValue: 0x313547)
