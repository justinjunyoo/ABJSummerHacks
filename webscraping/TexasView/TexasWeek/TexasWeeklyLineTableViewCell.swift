//
//  TexasWeeklyLineTableViewCell.swift
//  webscraping
//
...
class TexasWeeklyLineTableViewCell: UITableViewCell, ChartViewDelegate {
    
    @IBOutlet weak var lineChart: LineChartView!
    @IBOutlet weak var texasWeekLineView: UIView!
    var circleColors: [NSUIColor] = []
    
    override func awakeFromNib() {
        super.awakeFromNib()
        lineChart.delegate = self
        texasWeekLineView.backgroundColor = AppDelegate().uicolorFromHex(rgbValue: 0x313547)
