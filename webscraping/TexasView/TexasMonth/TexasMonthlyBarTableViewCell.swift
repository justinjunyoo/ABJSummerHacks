//
//  TexasMonthlyBarTableViewCell.swift
//  webscraping
//
...
class TexasMonthlyBarTableViewCell: UITableViewCell, ChartViewDelegate {

    @IBOutlet weak var barChart: BarChartView!
    @IBOutlet weak var texasMonthBarView: UIView!
    var circleColors: [NSUIColor] = []
    
    override func awakeFromNib() {
        super.awakeFromNib()
        barChart.delegate = self
        texasMonthBarView.backgroundColor = AppDelegate().uicolorFromHex(rgbValue: 0x313547)
